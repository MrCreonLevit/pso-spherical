...
def pso(f, d, n, population_size=1000, max_iterations=100, w=0.95, c1=0.5, c2=0.4, c3=0.2, verbose=True, plots=True): 
    limit = 10.0
    ...
    for t in range(max_iterations):
        ...
        velocities = (w * velocities + 
                      ...
                      )) * (1 - (t/max_iterations)) # final quotient term is "cooling" term.
...
if __name__ == "__main__":
    ...
    result, final_variance = pso(min_angle, d=4, n=24, population_size=30, max_iterations=30000000, plots=False) # almost finds E8?
