...
def pso(f, d, n, population_size=1000, max_iterations=100, w=0.95, c1=0.5, c2=0.0, c3=0.2, verbose=False, plots=True): #workhorse
    # log parameters
...
output_filename = f"pso_output_{timestamp}.log"
...
if __name__ == "__main__":
    ...
    print("Optimizing minimum angle with PSO:", file=output_file, flush=True)
    result, final_variance = pso(min_angle, d=4, n=120, population_size=30, max_iterations=100_000, c2=0.0, plots=False) 
